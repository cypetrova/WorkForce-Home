...
Извличане на данни от двете бази данни (dbo.lica и dbo.dom) и изчисляване на разлика във възраста, ако има таква новата стойност (т.е. разликата) да се презапише в колона age намираща се в dbo.lica

SQL заявка за извличане на данните от двете таблици базирани на съвпадение на стойностите при колоните oblast, grs, gnezdo, domak и tm. 

Изчисляване на разликата във възраста между стойностите на колоните ppd, ppm, ppg и db, dm, dg. 

Ако стойността на изчислената разлика е различна от текущата стойност в колоната age в табл dbo.lica, стойността да се презапише. 

Извеждане на обновената колона в общата таблица tPersons. 
