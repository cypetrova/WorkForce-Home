...
function D15(val1) {
    ...
    var errMsg = "Д15<= Д10(възраст).Задължителна проверка.";
    var errMsg = "Лице " + " - Д15 (години в България) трябва да е по-малко или равно от Д10 (възраст)";
    var cMTable = 0;
...
function cancelButtonClicked() {
    document.getElementById("tPersons").reset();

    document.getElementById("tPerson").style.diplay = 'none';
}
...
function ClearPerson(mComm) {
    ...
    if (mComm == "Add") {
        ...
        document.getElementById("Maincontent_DDL20").selectedIndex = 0; // Промяна на променливата
    } else {
...
function EditPerson(mElem) {
    ...
    if (decode(myPerson.Stactv) === "Да") {
        document.getElementById("Maincontent_DDL20").checked = true; // Промяна на променли
        document.getElementById("Maincontent_DDL20").checked = true; // Промяна на променливата
    } else {
        document.getElementById("Maincontent_DDL20").checked = false; // Промяна на променливата
    }
